...
class User(db.Model):
    ...
    _owins = db.Column(db.Integer, unique=False, nullable=True)
    _xwins = db.Column(db.Integer, unique=False, nullable=True)
    ...
    def __init__(self, name, uid, o_wins, x_wins, password="123qwerty", dob=date.today()):
